...
public class PocetnaController {
    ...
    public String getPocetna(Model model) {
        System.out.println("DEBUG: getPocetna method called");
        ...
        try {
            ...
            if (ulogovaniKorisnik != null) {
                System.out.println("DEBUG: Korisnik found: " + ulogovaniKorisnik.getKorisnickoIme());
                model.addAttribute("user", ulogovaniKorisnik);
            } else {
                System.out.println("DEBUG: Korisnik not found for user: " + user.getUsername());
            }
        } catch (Exception e) {
            System.out.println("DEBUG: Error in getPocetna: " + e.getMessage());
            e.printStackTrace();
        }
        
        System.out.println("DEBUG: Returning pocetna view");
        return "pocetna";
    }
    ...
    public String redirection(Model model) {
        System.out.println("DEBUG: redirection method called");
        try {
            User user = (User) SecurityContextHolder
                    .getContext()
                    .getAuthentication()
            ...
            System.out.println("DEBUG: Error in redirection method: " + e.getMessage());
            e.printStackTrace();
        }
        return "roleselect";
    }
